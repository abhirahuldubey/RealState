...
export class AddPropertyComponent implements OnInit {
  ...
  cityList: Array<string> = ['Kalyan', 'Thane', 'Dadar', 'CST'];
  ...
  constructor(
    ...
    private alertyfy: AltertyfyService
  ) {}
  ...
  onSubmit() {
    ...
    if (this.allTabsValid()) {
      ...
      this.alertyfy.success('Successfully Save');
      ...
      this.alertyfy.error('Not Save Successfully');
    }
  }
